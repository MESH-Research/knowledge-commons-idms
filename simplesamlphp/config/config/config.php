...
$cookie_name_suffix = $server_name_array[0];
...
$config = [
     ...
     * root directory.
     */
    'certdir' => '/var/simplesamlphp_local/cert/',
    'loggingdir' => '/var/simplesamlphp_local/log/',
    'datadir' => 'data/',
    'tempdir' => '/var/simplesamlphp_local/tmp/',
    ...
    'technicalcontact_email' => 'eknappe@mla.org',
     ...
     */
    'secretsalt' => 'h417yclsdh6ktd7nu6i7wweos3qobdir',
     ...
     */
    'auth.adminpassword' => '27CJp3Q0E59nQG6e4awT',
     ...
     */
    'trusted.url.domains' => [ '.*\.hcommons\-staging\.org' ],
     ...
     */
    'session.cookie.name' => 'SimpleSAMLSessionID' . $cookie_name_suffix,
     ...
     */
    // 'baseurlpath' => 'https://' . $_SERVER['SERVER_NAME'] . '/simplesaml/',
    'session.phpsession.cookiename' => 'SimpleSAML' .  $cookie_name_suffix,
     ...
     */
    'session.authtoken.cookiename' => 'SimpleSAMLAuthToken' . $cookie_name_suffix,
     ...
     */
    //'theme.use' => 'hcthemes:idpolrtheme',
     ...
     */
    'metadatadir' => '/var/simplesamlphp_local/metadata',
